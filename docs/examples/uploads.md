...
File uploads using multipart/form-data with composition.

- Composition with `body.multipart()`
- Text parts (`body.text()`), binary parts (`body.binary()`)
- MIME type validation
- File size limits
- Filename sanitization
- Client reuse for multiple uploads
...
<p align="center">
  <a href="#/examples/auth">← Auth</a> · <a href="#/examples/graphql">GraphQL →</a>
</p>